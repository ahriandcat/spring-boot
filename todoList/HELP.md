...
* The following dependencies are not known to work with Spring Native: 'Apache Freemarker, Spring Boot DevTools, Spring
  Configuration Processor, Spring Web Services'. As a result, your application may not work as expected.
...
```
$ docker run --rm -p 8080:8080 todoList:0.0.1-SNAPSHOT
```
