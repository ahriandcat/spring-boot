...
* The following dependencies are not known to work with Spring Native: 'Spring Configuration Processor, Rest
  Repositories, Apache Freemarker, Spring Boot DevTools, Spring Web Services'. As a result, your application may not
  work as expected.
...
* [Apache Freemarker](https://docs.spring.io/spring-boot/docs/2.7.0/reference/htmlsingle/#boot-features-spring-mvc-template-engines)
...
```
$ docker run --rm -p 8080:8080 ThymeleafApp:0.0.1-SNAPSHOT
```
